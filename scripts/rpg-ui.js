Hooks.on('init', () => 
{
	...
	game.settings.register('final-fantasy-xiv-ui', 'disableAllStyles', 
	{
	...
	game.settings.register('final-fantasy-xiv-ui', 'minimalUICompatibility', 
	{
	...
	if (!game.settings.get('final-fantasy-xiv-ui', 'disableAllStyles')) { rpgUIAddMainCss() }
	if (game.settings.get('final-fantasy-xiv-ui', 'minimalUICompatibility')) { addClassByQuerySelector('minimal-ui-mode', 'body.vtt') }
});
...
function rpgUIAddMainCss() 
{
	...
	mainCss.setAttribute("href", "modules/final-fantasy-xiv-ui/css/pathfinderui.css")
...
Hooks.on('renderSidebarTab', async (object, html) => 
{
	if (object instanceof Settings) {
	  ...
	  list.innerHTML = await renderTemplate('modules/final-fantasy-xiv-ui/templates/settings-info.hbs')
